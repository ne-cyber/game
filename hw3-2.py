...
player_size = (20,20)
player = pygame.image.load('player.png').convert_alpha() #pygame.Surface((20,20))
...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH, random.randint(0, HEIGHT - 200), *enemy_size)
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(WIDTH//2, 0, *bonus_size)
